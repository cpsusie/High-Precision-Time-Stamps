...
namespace HpTimesStamps
{
    ...
    public readonly struct Duration : IComparable<Duration>, IEquatable<Duration>
    {
        ...
        /// </summary>
        public static readonly long TicksPerMinute = TicksPerSecond * 60;
        /// <summary>
        /// Number of ticks per hour.
        /// </summary>
        public static readonly long TicksPerHour = TicksPerMinute * 60;
        /// <summary>
        /// Number of ticks per day 
        /// </summary>
        public static readonly long TicksPerDay = TicksPerHour * 24;
        ...
        /// </summary>
        internal static readonly TickInt MaxSeconds = TickInt.MaxValue / TicksPerSecond;
        /// <summary>
        /// Longest negative period representable in seconds
        /// </summary>
        internal static readonly TickInt MinSeconds = TickInt.MinValue / TicksPerSecond;
        /// <summary>
        /// Longest positive period represented in milliseconds
        /// </summary>
        internal static readonly TickInt MaxMilliseconds = TickInt.MaxValue / TicksPerMillisecond;
        /// <summary>
        /// Longest negative period represented in millisecond
        /// </summary>
        internal static readonly TickInt MinMilliseconds = TickInt.MinValue / TicksPerMillisecond;
        /// <summary>
        /// Number of ticks in a tenth of a second
        /// </summary>
        internal static readonly TickInt TicksPerTenthSecond = TicksPerMillisecond * 100;
        /// <summary>
        ...
        {
            if (Ticks == HpTimesStamps.Duration.MinValue.Ticks)
        ...
        public Duration Add(in Duration ts)
        {
            ...
            if ((_ticks >> TickIntRightShiftGetSignBitAmount == ts._ticks >> TickIntRightShiftGetSignBitAmount) && (_ticks >> TickIntRightShiftGetSignBitAmount != result >> TickIntRightShiftGetSignBitAmount))
        ...
        {
            if (t._ticks == HpTimesStamps.Duration.MinValue._ticks)
        ...
        internal static TickInt TimeToTicks(int hour, int minute, int second)
        {
            ...
            TickInt totalSeconds = (TickInt)hour * 3600 + (TickInt)minute * 60 + (TickInt)second;
